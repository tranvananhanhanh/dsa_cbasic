...
void AddLeft(Node** r, char u, char v) {
    Node* pu = find(*r, u);
    if (pu != NULL) {
        return ;
    }
...
void AddRight(Node** r, char u, char v) {
    Node* pu = find(*r, u);
    if (pu != NULL) {
        return ;
    }
...
int main() {
    ...
    while (fgets(buff, sizeof(buff), stdin)) {
        ...
        if (k == 2) {
            ...
            if (strcmp(buff, "PreOrder") == 0) {
                PreOrder(root);
                printf("\n");
            } else if (strcmp(buff, "PostOrder") == 0) {
                PostOrder(root);
                printf("\n");
            } else if (strcmp(buff, "InOrder") == 0) {
                InOrder(root);
                printf("\n");
            }
        }
